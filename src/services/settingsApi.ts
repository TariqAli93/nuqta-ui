...
export const settingsApi = {
  ...
  barcode: {
    get: (): Promise<ApiResult<BarcodeSettings>> =>
      apiGet<BarcodeSettings>('/settings/barcode-config'),
    update: (data: Partial<BarcodeSettings>): Promise<ApiResult<BarcodeSettings>> =>
      apiPut<BarcodeSettings>('/settings/barcode-config', data),
  },
